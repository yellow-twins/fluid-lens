...
final class RuleCatalog
{
    ...
    private const DESCRIPTIONS = [
        ...
        'wcag.autocomplete-token' => 'Invalid autocomplete autofill token',
        'wcag.lang-xml-mismatch' => 'lang and xml:lang disagree',
        'wcag.accesskey-duplicate' => 'Duplicate accesskey in one document',
        'wcag.target-blank-purpose' => 'target="_blank" without announcing the new tab (AAA)',
        'wcag.aria-controls-target' => 'aria-controls with no matching id in the template',
        'wcag.aria-ref-target' => 'aria-labelledby/describedby with no matching id',
        'wcag.nav-label' => 'Multiple navigation landmarks without labels',
